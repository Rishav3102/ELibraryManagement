...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        ...
        function setBookImageUrl(bookName, bookImgUrl) {
            var path = GenerateUrl("GetBookInformation.aspx", bookName, bookImgUrl);
            window.location.href = path;
        }

        function GenerateUrl(defaultPath, bookName, bookImgUrl) {
            var searchParams = new URLSearchParams();
            searchParams.set('bookName', bookName);
            searchParams.set('bookImgUrl', bookImgUrl);
            ...
            <div class="col-md-5">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-4">
                                <asp:Button ID="Button1" class="btnBlockCustom btn btn-lg btn-block btn-success" runat="server" Text="Add" OnClick="Button1_Click" />
                            </div>
                            <div class="col-4">
                                <asp:Button ID="Button3" class="btnBlockCustom btn btn-lg btn-block btn-warning" runat="server" Text="Update" OnClick="Button3_Click" />
                            </div>
                            <div class="col-4">
                                <asp:Button ID="Button2" class=" btnBlockCustom btn btn-lg btn-block btn-danger" runat="server" Text="Delete" OnClick="Button2_Click" />
                            </div>
                        </div>
                    </div>
                </div>
                                                ...
                                                <div class="container-fluid">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-10">
                                                            <div class="row">
                                                                <div class="col-12">
                                                                    <a id="anchorBookInventory" href="#" onclick="setBookImageUrl('<%# Eval("book_name") %>','<%# Eval("book_img_link") %>'); return false"><asp:Label ID="Label1" runat="server" Text='<%# Eval("book_name") %>' Font-Bold="True" Font-Size="X-Large"></asp:Label></a>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-12">
                                                                    ...
                                                                    &nbsp;| Publish-Date-<asp:Label ID="Label6" runat="server" Font-Bold="True" Text='<%# Eval("publisher_date") %>'></asp:Label>
                                                        ...
                                                        <div class="col-lg-2">
                                                            <asp:Image CssClass = "img-fluid bookImageUrl" class="img-fluid" ID="Image1" runat="server" ImageUrl='<%# Eval("book_img_link") %>' />
                                                        </div>
                                                    </div>
                                                </div>
                                            </ItemTemplate>
