                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <div class="form-group formGroupCustom">
                                    <label>Emaild</label>
                                    <asp:TextBox CssClass="form-control" ID="newEmail" runat="server" TextMode="Email" ReadOnly="True"></asp:TextBox>
                                </div>
                                <div class="form-group formGroupCustom">
                                ...
                                <div class="form-group formGroupCustom">
                                    <asp:Button class="btn btn-success btn-lg btn-block btnBlockCustom" ID="Button1" runat="server" Text="Reset Password" OnClick="Button1_Click" />
                                </div>
